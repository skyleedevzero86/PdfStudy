...
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS model_name  VARCHAR(100);
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS model_type  VARCHAR(50);
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS endpoint    VARCHAR(500);
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS is_active   BOOLEAN DEFAULT TRUE;
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS config_json JSONB;
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS created_at  TIMESTAMP NOT NULL DEFAULT NOW();
ALTER TABLE ai_model_configs ADD COLUMN IF NOT EXISTS updated_at  TIMESTAMP NOT NULL DEFAULT NOW();
